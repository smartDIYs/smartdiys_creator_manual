...
- (10) キャプチャ: (EtcherLaserのみ) 加工機のカメラで撮影した加工エリアの範囲をキャンバス上に表示します。カメラマーカが障害物で隠れないように注意してください。  
...
- アイテムを追加: クリックすることでメニューが表示され、プロジェクトにアイテムを追加することができます。
 ...
 - スキャン:（EtcherLaserのみ） 加工機のカメラでスキャンした画像からデータを作成することができます。※上蓋が閉まっている場合はボタンが無効になります。
